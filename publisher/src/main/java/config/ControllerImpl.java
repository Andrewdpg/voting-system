                ...
                for (int i = 0; i < BATCH_SIZE && !messageQueue.isEmpty(); i++) {
                    ...
                    if (message instanceof QueryResult queryResult) {
                        ...
                        writer.append(String.valueOf(queryResult.citizenId)).append(",")
                            .append(queryResult.pollingStation != null? queryResult.pollingStation.state + " - " + queryResult.pollingStation.city + " - " +queryResult.pollingStation.address + " - " +queryResult.pollingStation.post + " - " : "not found").append(",")
